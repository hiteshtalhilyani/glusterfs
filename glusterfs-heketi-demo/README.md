...
# Test password less login 
 ssh -i /etc/heketi/heketi_key gluster-2
...
heketi-cli cluster info 0ebbabbf4fae823a81aeb42f11fea11f

 $ heketi-cli node add \
      --zone=3 \
      --cluster=0ebbabbf4fae823a81aeb42f11fea11f \
      --management-host-name=gluster-1 \
      --storage-host-name=gluster-1
